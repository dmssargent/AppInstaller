...
namespace APKInstaller
{
    ...
    public partial class Main : Form
    {
        ...
        private void APKInstallerMain_Load(object sender, EventArgs e)
        {
            ...
            //byte[] roboto = Resources.roboto_regular;
            //IntPtr font = Marshal.AllocCoTaskMem(Resources.roboto_regular.Length);
           //// Marshal.Copy(Resources.roboto_regular, 0, font, Resources.roboto_regular.Length);
           // foo.AddMemoryFont(font, roboto.Length);
            //Marshal.FreeCoTaskMem(font);
            //var foo2 = foo.Families[0];
           // var ROBOTO = new Font(foo2, this.Font.Size, this.Font.Unit);
           // this.Font = ROBOTO;
           // this.lblStatus.Font = ROBOTO;
           // this.lnkHelp.Font = ROBOTO;
            this.lnkHelp.BackColor = Color.White;

            //this.lnkAbout.Font = ROBOTO;
            this.lnkAbout.BackColor = Color.White;
